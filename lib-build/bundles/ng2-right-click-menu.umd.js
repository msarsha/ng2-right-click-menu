(function (global, factory) {
	...
	(factory((global['ng2-right-click-menu'] = {}),global.ng.core,global.ng.common));
...
HtmlDirective.propDecorators = {
    'content': [{ type: core.Input, args: ['sh-html',] },],
};
...
ShContextMenuComponent.propDecorators = {
    ...
    'childRef': [{ type: core.ViewChild, args: ['childRef',] },],
};
var ShContextMenuDirective = /** @class */ (function () {
    ...
    function ShContextMenuDirective(ctxService, injectionService) {
        ...
        this.onBeforeMenuOpen = new core.EventEmitter();
    }
    /**
     * @param {?} event
     * @return {?}
...
ShContextMenuDirective.propDecorators = {
    'menuItems': [{ type: core.Input, args: ['sh-context',] },],
    'dataContext': [{ type: core.Input, args: ['sh-data-context',] },],
    'options': [{ type: core.Input, args: ['sh-options',] },],
    'onBeforeMenuOpen': [{ type: core.Output, args: ['onBeforeMenuOpen',] },],
    'onClick': [{ type: core.HostListener, args: ['contextmenu', ['$event'],] },],
};
var ShContextSubMenuDirective = /** @class */ (function () {
    ...
    function ShContextSubMenuDirective(viewRef, elmRef, resolver, ctxService) {
        ...
        this.ctxService = ctxService;
        this.closeSubMenu = new core.EventEmitter();
    }
    /**
     * @return {?}
     */
...
ShContextSubMenuDirective.propDecorators = {
    'menuItems': [{ type: core.Input, args: ['sh-context-sub-menu',] },],
    'dataContext': [{ type: core.Input, args: ['sh-data-context',] },],
    'closeSubMenu': [{ type: core.Output },],
...
exports.ɵh = HtmlDirective;
exports.ɵd = InjectionService;
exports.ɵe = ShContextMenuComponent;
exports.ɵa = ShContextMenuDirective;
exports.ɵg = ShContextOverlayComponent;
exports.ɵb = ShContextService;
exports.ɵc = ShContextServiceModule;
exports.ɵf = ShContextSubMenuDirective;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ng2-right-click-menu.umd.js.map
